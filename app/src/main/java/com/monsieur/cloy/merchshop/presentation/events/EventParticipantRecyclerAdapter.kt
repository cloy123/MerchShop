...
class EventParticipantRecyclerAdapter  (val context: Context): RecyclerView.Adapter<EventParticipantRecyclerAdapter.ViewHolder>() {

    private var participants: List<EventParticipant>? = null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val v = LayoutInflater.from(parent.context).inflate(R.layout.event_participants_card, parent, false)
        return ViewHolder(v)
    }
